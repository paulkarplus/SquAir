...
#include <stddef.h>
#include "blas.h"
#include "quad_model_V2_sfun.h"
#include "c1_quad_model_V2.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "quad_model_V2_sfun_debug_macros.h"
...
static const char * c1_debug_family_names[5] = { "Prop_Data", "nargin",
  "nargout", "servo_cmd", "thrust" };

/* Function Declarations */
static void initialize_c1_quad_model_V2(SFc1_quad_model_V2InstanceStruct
  *chartInstance);
static void initialize_params_c1_quad_model_V2(SFc1_quad_model_V2InstanceStruct *
  chartInstance);
static void enable_c1_quad_model_V2(SFc1_quad_model_V2InstanceStruct
  *chartInstance);
static void disable_c1_quad_model_V2(SFc1_quad_model_V2InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_quad_model_V2
  (SFc1_quad_model_V2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_quad_model_V2
  (SFc1_quad_model_V2InstanceStruct *chartInstance);
static void set_sim_state_c1_quad_model_V2(SFc1_quad_model_V2InstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_quad_model_V2(SFc1_quad_model_V2InstanceStruct
  *chartInstance);
static void sf_c1_quad_model_V2(SFc1_quad_model_V2InstanceStruct *chartInstance);
static void initSimStructsc1_quad_model_V2(SFc1_quad_model_V2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_quad_model_V2InstanceStruct
  *chartInstance, const mxArray *c1_thrust, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_quad_model_V2InstanceStruct
...
static real_T c1_interp1(SFc1_quad_model_V2InstanceStruct *chartInstance, real_T
  c1_varargin_1[16], real_T c1_varargin_2[16], real_T c1_varargin_3);
static void c1_eml_error(SFc1_quad_model_V2InstanceStruct *chartInstance);
static void c1_b_eml_error(SFc1_quad_model_V2InstanceStruct *chartInstance);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_quad_model_V2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_quad_model_V2InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_quad_model_V2, const char_T
  *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_quad_model_V2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_quad_model_V2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_quad_model_V2 = 0U;
}
  ...
  (SFc1_quad_model_V2InstanceStruct *chartInstance)
{
  ...
  real_T *c1_thrust;
  c1_thrust = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellarray(2), FALSE);
  c1_hoistedGlobal = *c1_thrust;
  c1_u = c1_hoistedGlobal;
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", &c1_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c1_y, 0, c1_b_y);
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_quad_model_V2;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_thrust = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    0)), "thrust");
  chartInstance->c1_is_active_c1_quad_model_V2 = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_quad_model_V2");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_quad_model_V2(chartInstance);
...
static void sf_c1_quad_model_V2(SFc1_quad_model_V2InstanceStruct *chartInstance)
{
  ...
  real_T c1_Prop_Data[32];
  real_T c1_nargin = 1.0;
  real_T c1_nargout = 1.0;
  real_T c1_thrust;
  int32_T c1_i0;
  static real_T c1_dv0[32] = { 0.0, 1697.14285714286, 2382.85714285714,
    2682.85714285714, 3248.57142857143, 3574.28571428571, 4122.85714285714,
    4285.71428571429, 4654.28571428571, 4868.57142857143, 5100.0, 5640.0,
    5717.14285714286, 6214.28571428571, 6591.42857142857, 6805.71428571429, 0.0,
    22.0, 42.0, 54.0, 84.0, 102.0, 129.0, 152.0, 167.0, 180.0, 215.0, 248.0,
    267.0, 290.0, 345.0, 385.0 };

  int32_T c1_i1;
  static real_T c1_y[16] = { 0.0, 249.37027707808593, 350.12594458438224,
    394.20654911838727, 477.32997481108305, 525.18891687657344,
    605.79345088161142, 629.72292191435781, 683.87909319899143,
    715.36523929471014, 749.37027707808522, 828.71536523929421, 840.050377833753,
    913.09823677581744, 968.51385390428129, 1000.0 };
  ...
  int32_T c1_i5;
  int32_T c1_i6;
  real_T c1_b_Prop_Data[16];
  int32_T c1_i7;
  real_T c1_c_Prop_Data[16];
  real_T *c1_b_servo_cmd;
  real_T *c1_b_thrust;
  c1_b_thrust = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_servo_cmd = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c1_b_servo_cmd, 0U);
  _SFD_DATA_RANGE_CHECK(*c1_b_thrust, 1U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  c1_hoistedGlobal = *c1_b_servo_cmd;
  c1_servo_cmd = c1_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 5U, 5U, c1_debug_family_names,
    c1_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_Prop_Data, 0U, c1_b_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 2U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_servo_cmd, 3U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_thrust, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 3);
  for (c1_i0 = 0; c1_i0 < 32; c1_i0++) {
    c1_Prop_Data[c1_i0] = c1_dv0[c1_i0];
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 22);
  for (c1_i1 = 0; c1_i1 < 16; c1_i1++) {
    c1_Prop_Data[c1_i1] = c1_y[c1_i1];
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 25);
  for (c1_i2 = 0; c1_i2 < 16; c1_i2++) {
    c1_a[c1_i2] = c1_Prop_Data[c1_i2 + 16];
  }
  ...
  for (c1_i5 = 0; c1_i5 < 16; c1_i5++) {
    c1_Prop_Data[c1_i5 + 16] = c1_a[c1_i5];
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 27);
  for (c1_i6 = 0; c1_i6 < 16; c1_i6++) {
    c1_b_Prop_Data[c1_i6] = c1_Prop_Data[c1_i6];
  }

  for (c1_i7 = 0; c1_i7 < 16; c1_i7++) {
    c1_c_Prop_Data[c1_i7] = c1_Prop_Data[c1_i7 + 16];
  }

  c1_thrust = c1_interp1(chartInstance, c1_b_Prop_Data, c1_c_Prop_Data,
    c1_servo_cmd);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -27);
  _SFD_SYMBOL_SCOPE_POP();
  *c1_b_thrust = c1_thrust;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_quad_model_V2MachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_quad_model_V2InstanceStruct *chartInstance;
  chartInstance = (SFc1_quad_model_V2InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c1_thrust, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_thrust), &c1_thisId);
  sf_mex_destroy(&c1_thrust);
  return c1_y;
}
...
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  const mxArray *c1_thrust;
  const char_T *c1_identifier;
  emlrtMsgIdentifier c1_thisId;
  real_T c1_y;
  SFc1_quad_model_V2InstanceStruct *chartInstance;
  chartInstance = (SFc1_quad_model_V2InstanceStruct *)chartInstanceVoid;
  c1_thrust = sf_mex_dup(c1_mxArrayInData);
  ...
  *c1_inData)
{
  ...
  for (c1_i9 = 0; c1_i9 < 2; c1_i9++) {
    for (c1_i10 = 0; c1_i10 < 16; c1_i10++) {
      c1_b_inData[c1_i10 + c1_i8] = (*(real_T (*)[32])c1_inData)[c1_i10 + c1_i8];
    }
  ...
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 2, 16, 2), FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}

const mxArray *sf_c1_quad_model_V2_get_eml_resolved_functions_info(void)
{
  const mxArray *c1_nameCaptureInfo = NULL;
  c1_nameCaptureInfo = NULL;
  sf_mex_assign(&c1_nameCaptureInfo, sf_mex_createstruct("structure", 2, 45, 1),
                FALSE);
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1373338908U), "fileTimeLo",
                  "fileTimeLo", 0);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 0);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1319762366U), "mFileTimeLo",
                  "mFileTimeLo", 0);
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 4);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1363742666U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("interp1"), "name", "name", 7);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1360314752U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m"),
                  "resolved", "resolved", 8);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851176U), "fileTimeLo",
                  "fileTimeLo", 8);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 8);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1346542740U), "fileTimeLo",
                  "fileTimeLo", 14);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 14);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 16);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("isnan"), "name", "name", 16);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 19);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("flipdim"), "name", "name", 19);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 19);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flipdim.m"), "resolved",
                  "resolved", 19);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851088U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, sf_mex_duplicatearraysafe(&c1_lhs19), "lhs", "lhs",
                  19);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flipdim.m"), "context",
                  "context", 20);
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flipdim.m"), "context",
                  "context", 25);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_matrix_vstride"), "name",
                  "name", 25);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1360314750U), "fileTimeLo",
                  "fileTimeLo", 25);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 25);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851178U), "fileTimeLo",
                  "fileTimeLo", 27);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851180U), "fileTimeLo",
                  "fileTimeLo", 29);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 29);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flipdim.m"), "context",
                  "context", 31);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_matrix_npages"), "name",
                  "name", 31);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 38);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_bsearch"), "name", "name",
                  38);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_bsearch.m"), "resolved",
                  "resolved", 38);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851096U), "fileTimeLo",
                  "fileTimeLo", 38);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 38);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, sf_mex_duplicatearraysafe(&c1_lhs38), "lhs", "lhs",
                  38);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_bsearch.m"), "context",
                  "context", 39);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_index_class"), "name",
                  "name", 39);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(""), "dominantType",
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1323202980U), "fileTimeLo",
                  "fileTimeLo", 40);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 40);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_bsearch.m"), "context",
                  "context", 42);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("intmax"), "name", "name", 42);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 44);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mtimes"), "name", "name", 44);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 44);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  c1_varargin_1[16], real_T c1_varargin_2[16], real_T c1_varargin_3)
{
  ...
  for (c1_i14 = 0; c1_i14 < 16; c1_i14++) {
    c1_y[c1_i14] = c1_varargin_2[c1_i14];
  }

  c1_xi = c1_varargin_3;
  for (c1_i15 = 0; c1_i15 < 16; c1_i15++) {
    c1_x[c1_i15] = c1_varargin_1[c1_i15];
  }
  ...
  do {
    ...
    if (c1_k < 17) {
      ...
      if (c1_x[1] < c1_x[0]) {
        for (c1_j1 = 1; c1_j1 < 9; c1_j1++) {
          c1_b_j1 = c1_j1;
          c1_xtmp = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c1_b_j1), 1, 16, 1, 0) - 1];
          c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_b_j1), 1, 16, 1, 0) - 1] =
            c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(17 - c1_b_j1)), 1, 16, 1, 0) - 1];
          c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(17 - c1_b_j1)), 1, 16, 1, 0) - 1] = c1_xtmp;
        }
        ...
        while (c1_ixleft < c1_ixright) {
          c1_tmp = c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c1_ixleft), 1, 16, 1, 0) - 1];
          c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_ixleft), 1, 16, 1, 0) - 1] =
            c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_ixright), 1, 16, 1, 0) - 1];
          c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_ixright), 1, 16, 1, 0) - 1] = c1_tmp;
          c1_a = c1_ixleft + 1;
          c1_ixleft = c1_a;
          c1_b_a = c1_ixright - 1;
          c1_ixright = c1_b_a;
      ...
      if (c1_xi > c1_xhi) {
        ...
        while (c1_high_i > c1_low_ip1 + 1) {
          ...
          if (c1_b_xi >= c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", (real_T)c1_mid_i), 1, 16, 1, 0) - 1]) {
            c1_low_i = c1_mid_i;
            c1_low_ip1 = c1_low_i;
          } else {
            c1_high_i = c1_mid_i;
        ...
        c1_xn = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c1_n), 1, 16, 1, 0) - 1];
        c1_xnp1 = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)(c1_n + 1)), 1, 16, 1, 0) - 1];
        if (c1_n == 0) {
        } else {
          c1_r = (c1_xi - c1_xn) / (c1_xnp1 - c1_xn);
          c1_onemr = 1.0 - c1_r;
          c1_y1 = c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c1_n), 1, 16, 1, 0) - 1];
          c1_y2 = c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)(c1_n + 1)), 1, 16, 1, 0) - 1];
          if (c1_y1 == c1_y2) {
            c1_yi = c1_y1;
          } else {
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_quad_model_V2), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_quad_model_V2);
  return c1_y;
}
...
void sf_c1_quad_model_V2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2279296432U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4109670284U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2985688494U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(255297677U);
}

mxArray *sf_c1_quad_model_V2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("pNT47bbCmmWd12qSmgY3cF");
...
mxArray *sf_c1_quad_model_V2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_quad_model_V2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_quad_model_V2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"thrust\",},{M[8],M[0],T\"is_active_c1_quad_model_V2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_quad_model_V2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_quad_model_V2InstanceStruct *chartInstance;
    chartInstance = (SFc1_quad_model_V2InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_quad_model_V2MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_quad_model_V2MachineNumber_,
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"servo_cmd");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,619);
...

        {
          ...
          real_T *c1_thrust;
          c1_thrust = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c1_servo_cmd = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c1_servo_cmd);
          _SFD_SET_DATA_VALUE_PTR(1U, c1_thrust);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _quad_model_V2MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "m5HlOYVbfRhYi32O7aDtIC";
}

static void sf_opaque_initialize_c1_quad_model_V2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_quad_model_V2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_quad_model_V2((SFc1_quad_model_V2InstanceStruct*)
    chartInstanceVar);
  initialize_c1_quad_model_V2((SFc1_quad_model_V2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_quad_model_V2(void *chartInstanceVar)
{
  enable_c1_quad_model_V2((SFc1_quad_model_V2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_quad_model_V2(void *chartInstanceVar)
{
  disable_c1_quad_model_V2((SFc1_quad_model_V2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_quad_model_V2(void *chartInstanceVar)
{
  sf_c1_quad_model_V2((SFc1_quad_model_V2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_quad_model_V2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_quad_model_V2
    ((SFc1_quad_model_V2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_quad_model_V2();/* state var info */
...
extern void sf_internal_set_sim_state_c1_quad_model_V2(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_quad_model_V2((SFc1_quad_model_V2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_quad_model_V2(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_quad_model_V2(S);
}

static void sf_opaque_set_sim_state_c1_quad_model_V2(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_quad_model_V2(S, st);
}

static void sf_opaque_terminate_c1_quad_model_V2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_quad_model_V2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_quad_model_V2_optimization_info();
    }

    finalize_c1_quad_model_V2((SFc1_quad_model_V2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_quad_model_V2((SFc1_quad_model_V2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_quad_model_V2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_quad_model_V2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_quad_model_V2_optimization_info();
  ...
  ssSetChecksum0(S,(565025341U));
  ssSetChecksum1(S,(3441368192U));
  ssSetChecksum2(S,(1700460517U));
  ssSetChecksum3(S,(4120472567U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_quad_model_V2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_quad_model_V2(SimStruct *S)
{
  SFc1_quad_model_V2InstanceStruct *chartInstance;
  chartInstance = (SFc1_quad_model_V2InstanceStruct *)utMalloc(sizeof
    (SFc1_quad_model_V2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_quad_model_V2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_quad_model_V2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_quad_model_V2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_quad_model_V2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_quad_model_V2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_quad_model_V2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_quad_model_V2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_quad_model_V2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_quad_model_V2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_quad_model_V2;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_quad_model_V2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_quad_model_V2;
...
void c1_quad_model_V2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_quad_model_V2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_quad_model_V2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_quad_model_V2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_quad_model_V2_method_dispatcher.\n"
