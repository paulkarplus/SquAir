...
static const char * c2_debug_family_names[5] = { "Prop_Data", "nargin",
  "nargout", "servo_cmd", "thrust" };

/* Function Declarations */
static void initialize_c2_prop_thrust(SFc2_prop_thrustInstanceStruct
  *chartInstance);
static void initialize_params_c2_prop_thrust(SFc2_prop_thrustInstanceStruct
  *chartInstance);
static void enable_c2_prop_thrust(SFc2_prop_thrustInstanceStruct *chartInstance);
static void disable_c2_prop_thrust(SFc2_prop_thrustInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_prop_thrust
  (SFc2_prop_thrustInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_prop_thrust
  (SFc2_prop_thrustInstanceStruct *chartInstance);
static void set_sim_state_c2_prop_thrust(SFc2_prop_thrustInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_prop_thrust(SFc2_prop_thrustInstanceStruct
  *chartInstance);
static void sf_c2_prop_thrust(SFc2_prop_thrustInstanceStruct *chartInstance);
static void initSimStructsc2_prop_thrust(SFc2_prop_thrustInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_prop_thrustInstanceStruct *chartInstance,
  const mxArray *c2_thrust, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_prop_thrustInstanceStruct
...
static real_T c2_interp1(SFc2_prop_thrustInstanceStruct *chartInstance, real_T
  c2_varargin_1[16], real_T c2_varargin_2[16], real_T c2_varargin_3);
static void c2_eml_error(SFc2_prop_thrustInstanceStruct *chartInstance);
static void c2_b_eml_error(SFc2_prop_thrustInstanceStruct *chartInstance);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_prop_thrustInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_prop_thrustInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_prop_thrust, const char_T
  *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_prop_thrustInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_prop_thrustInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_prop_thrust = 0U;
}
  ...
  (SFc2_prop_thrustInstanceStruct *chartInstance)
{
  ...
  real_T *c2_thrust;
  c2_thrust = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2), FALSE);
  c2_hoistedGlobal = *c2_thrust;
  c2_u = c2_hoistedGlobal;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_prop_thrust;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_thrust = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    0)), "thrust");
  chartInstance->c2_is_active_c2_prop_thrust = c2_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_prop_thrust");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_prop_thrust(chartInstance);
...
static void sf_c2_prop_thrust(SFc2_prop_thrustInstanceStruct *chartInstance)
{
  ...
  real_T c2_Prop_Data[32];
  real_T c2_nargin = 1.0;
  real_T c2_nargout = 1.0;
  real_T c2_thrust;
  int32_T c2_i0;
  static real_T c2_dv0[32] = { 0.0, 1697.14285714286, 2382.85714285714,
  ...
  int32_T c2_i1;
  static real_T c2_y[16] = { 0.0, 249.37027707808593, 350.12594458438224,
  ...
  int32_T c2_i5;
  int32_T c2_i6;
  real_T c2_b_Prop_Data[16];
  int32_T c2_i7;
  real_T c2_c_Prop_Data[16];
  real_T *c2_b_servo_cmd;
  real_T *c2_b_thrust;
  c2_b_thrust = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_b_servo_cmd = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c2_b_servo_cmd, 0U);
  _SFD_DATA_RANGE_CHECK(*c2_b_thrust, 1U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_b_servo_cmd;
  c2_servo_cmd = c2_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 5U, 5U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_Prop_Data, 0U, c2_b_sf_marshallOut);
  ...
  for (c2_i5 = 0; c2_i5 < 16; c2_i5++) {
    c2_Prop_Data[c2_i5 + 16] = c2_a[c2_i5];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 27);
  for (c2_i6 = 0; c2_i6 < 16; c2_i6++) {
    c2_b_Prop_Data[c2_i6] = c2_Prop_Data[c2_i6];
  }

  for (c2_i7 = 0; c2_i7 < 16; c2_i7++) {
    c2_c_Prop_Data[c2_i7] = c2_Prop_Data[c2_i7 + 16];
  }

  c2_thrust = c2_interp1(chartInstance, c2_b_Prop_Data, c2_c_Prop_Data,
    c2_servo_cmd);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -27);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_prop_thrustInstanceStruct *chartInstance;
  chartInstance = (SFc2_prop_thrustInstanceStruct *)chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  for (c2_i9 = 0; c2_i9 < 2; c2_i9++) {
    for (c2_i10 = 0; c2_i10 < 16; c2_i10++) {
      c2_b_inData[c2_i10 + c2_i8] = (*(real_T (*)[32])c2_inData)[c2_i10 + c2_i8];
    }
...
const mxArray *sf_c2_prop_thrust_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  c2_nameCaptureInfo = NULL;
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 45, 1),
                FALSE);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("interp1"), "name", "name", 7);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/prodsize.m"),
                  "context", "context", 12);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mtimes"), "name", "name", 12);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 16);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isnan"), "name", "name", 16);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 19);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("flipdim"), "name", "name", 19);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 19);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flipdim.m"), "resolved",
                  "resolved", 19);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286851088U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 38);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_bsearch"), "name", "name",
                  38);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_bsearch.m"), "resolved",
                  "resolved", 38);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286851096U), "fileTimeLo",
                  "fileTimeLo", 38);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 38);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1323202980U), "fileTimeLo",
                  "fileTimeLo", 40);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 40);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 44);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mtimes"), "name", "name", 44);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 44);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  c2_varargin_1[16], real_T c2_varargin_2[16], real_T c2_varargin_3)
{
  ...
  for (c2_i14 = 0; c2_i14 < 16; c2_i14++) {
    c2_y[c2_i14] = c2_varargin_2[c2_i14];
  }

  c2_xi = c2_varargin_3;
  for (c2_i15 = 0; c2_i15 < 16; c2_i15++) {
    c2_x[c2_i15] = c2_varargin_1[c2_i15];
  }
  ...
  do {
    ...
    if (c2_k < 17) {
      ...
      if (c2_x[1] < c2_x[0]) {
        for (c2_j1 = 1; c2_j1 < 9; c2_j1++) {
          c2_b_j1 = c2_j1;
          c2_xtmp = c2_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c2_b_j1), 1, 16, 1, 0) - 1];
          c2_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c2_b_j1), 1, 16, 1, 0) - 1] =
            c2_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(17 - c2_b_j1)), 1, 16, 1, 0) - 1];
          c2_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(17 - c2_b_j1)), 1, 16, 1, 0) - 1] = c2_xtmp;
        }

        c2_ixleft = 1;
        c2_ixright = 16;
        while (c2_ixleft < c2_ixright) {
          c2_tmp = c2_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c2_ixleft), 1, 16, 1, 0) - 1];
          c2_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c2_ixleft), 1, 16, 1, 0) - 1] =
            c2_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c2_ixright), 1, 16, 1, 0) - 1];
          c2_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c2_ixright), 1, 16, 1, 0) - 1] = c2_tmp;
          c2_a = c2_ixleft + 1;
          c2_ixleft = c2_a;
          c2_b_a = c2_ixright - 1;
          c2_ixright = c2_b_a;
      ...
      if (c2_xi > c2_xhi) {
        ...
        while (c2_high_i > c2_low_ip1 + 1) {
          ...
          if (c2_b_xi >= c2_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", (real_T)c2_mid_i), 1, 16, 1, 0) - 1]) {
            c2_low_i = c2_mid_i;
            c2_low_ip1 = c2_low_i;
          } else {
            c2_high_i = c2_mid_i;
...
static void c2_eml_error(SFc2_prop_thrustInstanceStruct *chartInstance)
{
  ...
  char_T c2_u[21];
  const mxArray *c2_y = NULL;
  for (c2_i16 = 0; c2_i16 < 21; c2_i16++) {
    c2_u[c2_i16] = c2_cv0[c2_i16];
  }
...
static void c2_b_eml_error(SFc2_prop_thrustInstanceStruct *chartInstance)
{
  ...
  char_T c2_u[35];
  const mxArray *c2_y = NULL;
  for (c2_i17 = 0; c2_i17 < 35; c2_i17++) {
    c2_u[c2_i17] = c2_cv1[c2_i17];
  }
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_prop_thrust), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_prop_thrust);
  return c2_y;
}
...
void sf_c2_prop_thrust_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_prop_thrust_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_prop_thrust_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_prop_thrust_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_prop_thrust(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"thrust\",},{M[8],M[0],T\"is_active_c2_prop_thrust\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_prop_thrust_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_prop_thrustInstanceStruct *chartInstance;
    chartInstance = (SFc2_prop_thrustInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c2_thrust;
          c2_thrust = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c2_servo_cmd = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c2_servo_cmd);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_thrust);
        }
      }
    } else {
...
static void sf_opaque_initialize_c2_prop_thrust(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_prop_thrustInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_prop_thrust((SFc2_prop_thrustInstanceStruct*)
    chartInstanceVar);
  initialize_c2_prop_thrust((SFc2_prop_thrustInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_prop_thrust(void *chartInstanceVar)
{
  enable_c2_prop_thrust((SFc2_prop_thrustInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_prop_thrust(void *chartInstanceVar)
{
  disable_c2_prop_thrust((SFc2_prop_thrustInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_prop_thrust(void *chartInstanceVar)
{
  sf_c2_prop_thrust((SFc2_prop_thrustInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_prop_thrust(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_prop_thrust
    ((SFc2_prop_thrustInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_prop_thrust();/* state var info */
...
extern void sf_internal_set_sim_state_c2_prop_thrust(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_prop_thrust((SFc2_prop_thrustInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_prop_thrust(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_prop_thrust(S);
}

static void sf_opaque_set_sim_state_c2_prop_thrust(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_prop_thrust(S, st);
}

static void sf_opaque_terminate_c2_prop_thrust(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_prop_thrustInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_prop_thrust_optimization_info();
    }

    finalize_c2_prop_thrust((SFc2_prop_thrustInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_prop_thrust((SFc2_prop_thrustInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_prop_thrust(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_prop_thrust(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_prop_thrust(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_prop_thrust(SimStruct *S)
{
  SFc2_prop_thrustInstanceStruct *chartInstance;
  chartInstance = (SFc2_prop_thrustInstanceStruct *)utMalloc(sizeof
    (SFc2_prop_thrustInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_prop_thrustInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_prop_thrust;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_prop_thrust;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_prop_thrust;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_prop_thrust;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_prop_thrust;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_prop_thrust;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_prop_thrust;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_prop_thrust;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_prop_thrust;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_prop_thrust;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_prop_thrust;
...
void c2_prop_thrust_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_prop_thrust(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_prop_thrust(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_prop_thrust(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_prop_thrust_method_dispatcher.\n"
